...
export default async function MenusPage({ searchParams }: { searchParams: Promise<DateRangeParams> }) {
  ...
  return (
    <div className="page page-enter">
      ...
      <DistributionScatterPanel title="菜单分布气泡" description="按真实点击次数与设备覆盖范围查看菜单分布；相同位置自动聚合。" xLabel="菜单点击次数" yLabel="设备覆盖数" quadrantLabels={{ "high-high": "高点击·高覆盖", "low-high": "低点击·高覆盖", "high-low": "高点击·低覆盖", "low-low": "低点击·低覆盖" }} points={scatterPoints} mode="bubble-density" bubbleItemLabel="菜单" />
    </div>
  );
}
