/* FKK Signal consent-aware pseudonymous identity transport. */
(function (window, document) {
  "use strict";

  if (window.__fkkSignalUserIdentityV1) return;
  window.__fkkSignalUserIdentityV1 = true;

  var VISITOR_STORAGE_KEY = "fkk_signal_visitor_id";
  var SESSION_STORAGE_KEY = "fkk_signal_session_id";
  var config = Object.assign({ source: "shopify:fkk", siteKey: "fkk" }, window.FKK_SIGNAL_IDENTITY_CONFIG || {});
  ...
  loadPrivacyApi();
  window.FKKSignalIdentity = { track: track, refreshConsent: updatePermission };
})(window, document);
