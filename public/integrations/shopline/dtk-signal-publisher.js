/* DTK Signal storefront interactions - canonical hosted asset for SHOPLINE. */
(function (window, document) {
  "use strict";

  if (window.__dtkSignalPublisherV1) return;
  window.__dtkSignalPublisherV1 = true;
  ...
  function handleClick(event) {
    ...
    var targetKind = targetType(actionable);
    var params = {
      ...
      click_target: targetKind,
      device_category: deviceCategory(),
      heatmap_cell: heatmapCell(event),
      element_group: targetKind
    };
    publish("dtk_signal_click", params);
  }
